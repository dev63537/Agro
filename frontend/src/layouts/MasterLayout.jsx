  ...
  return (
    <div className="h-screen flex overflow-hidden bg-surface-100">
      ...
      <aside 
        ...
        aria-label="Master Administration Navigation"
        role="navigation"
      >
        <div className="sidebar-brand">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base font-bold text-secondary-900">Agro Billing</h2>
              <p className="text-xs text-secondary-400">Master Admin</p>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden">
        ...
        <header className="md:hidden bg-white border-b border-surface-200 px-4 py-3 flex items-center gap-3 sticky top-0 z-30">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-secondary-900">Agro Billing</span>
          </div>
        </header>
